...
namespace Api.Interfaces
{
    public interface IAnalyticService
    {
        ...
        LookupCount CreateLookupCount(int LookupId, decimal TotalCostOfExpenses, int NumberOfExpenses, ApplicationUser user, string lookupTypeName);
        ...
        decimal GetTotalCost(List<Expense> userExpenses);
    }
}